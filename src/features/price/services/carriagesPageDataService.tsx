  ...
  const dataArticle: ArticleProps = {
    ...
    content: (
      <div className="space-y-4">
        <p>
          Аренда кареты, экипажа или санок запряженных одной, парой или тройкой
          лошадей или пони! Имеется парк в количестве 6-и экипажей, карет, и 10
          саней разного размера и количества посадочных мест. Все кареты
          оборудованы ручными и ножными тормозами, сделаны в Германии, Польше,
          России - безопасные и качественные.
        </p>
      </div>
    ),
  };
