  ...
  return (
    <section className={cn("space-y-6", className)}>
      <div className="text-center">
        <h2 className="font-serif text-3xl text-[#2f3600] sm:text-4xl">{heading}</h2>
      </div>
          ...
          const content = (
            ...
            >
              ...
              <div className="space-y-2">
                <h3 className="text-xl font-semibold text-[#2f3600]">{item.title}</h3>
                <p className="text-sm leading-relaxed text-[#4b4d2f]">{item.description}</p>
              </div>
