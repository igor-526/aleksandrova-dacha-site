        ...
        <QuickServices
          items={[
            ...
            },
            {
              ...
              description:
                "Р РµРґРєРёРµ РїРѕСЂРѕРґС‹ РїРѕРЅРё Рё Р»РѕС€Р°РґРµР№ РїРѕ РґРѕСЃС‚СѓРїРЅС‹Рј С†РµРЅР°Рј.",
      ...
      <Container className="space-y-12 text-center">
        <section className="space-y-6">
          ...
          <p className="text-base text-[#4b4d2f]">
            РђР»РµРєСЃР°РЅРґСЂРѕРІР° Р”Р°С‡Р° вЂ” РѕРґРЅРѕ РёР· СЃР°РјС‹С…
            СѓСЋС‚РЅС‹С… РјРµСЃС‚ РІ Р›РµРЅРёРЅРіСЂР°РґСЃРєРѕР№ РѕР±Р»Р°СЃС‚Рё.
            РњС‹ СЃРѕР±СЂР°Р»Рё Р»СѓС‡С€РёС… С‚СЂРµРЅРµСЂРѕРІ Рё СЃР°РјС‹С…
            РґСЂСѓР¶РµР»СЋР±РЅС‹С… Р¶РёРІРѕС‚РЅС‹С…, С‡С‚РѕР±С‹ РІС‹ РјРѕРіР»Рё
            РїСЂРѕРІРµСЃС‚Рё РІСЂРµРјСЏ СЃ РїРѕР»СЊР·РѕР№ Рё
            СѓРґРѕРІРѕР»СЊСЃС‚РІРёРµРј.
          </p>
        </section>
        <Highlights
          items={[
            ...
            },
            {
              ...
              description:
                "РњР°СЂС€СЂСѓС‚С‹ РїРѕ РїР°СЂРєР°Рј, РїРѕР»СЏРј Рё Р»РµСЃР°Рј Р¦Р°СЂСЃРєРѕРіРѕ РЎРµР»Р°.",
              icon: "location",
            },
          ]}
        />
          ...
          offers={[
            {
              ...
              price: "РѕС‚ 1 500 в‚Ѕ",
              description:
                "РРЅРґРёРІРёРґСѓР°Р»СЊРЅС‹Р№ РјР°СЂС€СЂСѓС‚ РЅР° Р»РѕС€Р°РґРё СЃ РёРЅСЃС‚СЂСѓРєС‚РѕСЂРѕРј.",
              features: [
                "60 РјРёРЅСѓС‚",
            ...
            },
            {
              ...
              price: "РѕС‚ 800 в‚Ѕ",
              description:
                "Р—РЅР°РєРѕРјСЃС‚РІРѕ, РєРѕСЂРјР»РµРЅРёРµ Рё С„РѕС‚РѕСЃРµСЃСЃРёСЏ СЃ Р¶РёРІРѕС‚РЅС‹РјРё.",
              features: [
            ...
            },
            {
              ...
              price: "РѕС‚ 3 500 в‚Ѕ",
              description:
                "РџСЂРѕС„РµСЃСЃРёРѕРЅР°Р»СЊРЅР°СЏ СЃСЉРµРјРєР° СЃ Р»РѕС€Р°РґСЊРјРё Рё РїРѕРЅРё.",
              features: [
                "РџРѕРґР±РѕСЂ РѕР±СЂР°Р·Р°",
                "РћРїС‹С‚РЅС‹Р№ С„РѕС‚РѕРіСЂР°С„",
                "РћР±СЂР°Р±РѕС‚РєР° С„РѕС‚Рѕ",
              ],
            },
          ]}
        />
      ...
      <Container>
        <BookingSection
          ...
          image={{
            ...
            alt: "РџСЂРѕРіСѓР»РєР° РІРµСЂС…РѕРј",
          }}
          formProps={{
            options: [
              ...
              {
                value: "lesson",
                label: "РћР±СѓС‡РµРЅРёРµ РІРµСЂС…РѕРІРѕР№ РµР·РґРµ",
              },
            ],
          }}
        />
