...
export function AboutTeaser({ title, text, ctaLabel = "Подробнее", ctaHref = "/about", className }: AboutTeaserProps) {
  return (
    <section className={cn("rounded-3xl bg-[#fdfaf4] p-8 shadow-[0_24px_48px_rgba(56,64,0,0.08)]", className)}>
      ...
      <p className="mt-4 text-base leading-relaxed text-[#4b4d2f]">{text}</p>
