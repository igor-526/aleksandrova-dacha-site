...
export function ContactFarm({ address, phones, map, ctaLabel = "Построить маршрут", ctaHref = "https://yandex.ru/maps", className }: ContactFarmProps) {
  return (
    <section className={cn("grid gap-8 lg:grid-cols-2", className)}>
      <div className="space-y-5 rounded-3xl bg-[#fdfaf4] p-8 shadow-[0_24px_48px_rgba(56,64,0,0.08)]">
        ...
        <p className="flex items-start gap-3 text-sm text-[#4b4d2f]">
          <Icon name="location" width={20} height={20} className="mt-1 text-[#c9b585]" />
          {address}
        </p>
